...
const SecondChart = () => {
  useEffect(() => {
    ...
    // Create the chart for pH
    createChart(data, mainSvg, "chart1", margin, width, height, "pH");
  }, []);
  ...
  const createChart = (
    ...
    y.domain([0, d3.max(data, (d) => d[variable]) + 1]);
    ...
    svg
      ...
      .on("mouseover", (event, d) => {
        ...
        tooltip
          .html("Date: " + d.time + "<br>pH: " + d[variable])
  ...
  return <div id="chartContainer2"></div>;
};
